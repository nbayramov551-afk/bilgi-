...
# Ultra-Neural Səslər Databazası
VOICE_DB = {
    ...
    'es': 'es-ES-AlvaroNeural', 'is': 'is-IS-GudrunNeural', 'vi': 'vi-VN-NamMinhNeural',
    'th': 'th-TH-NiwatNeural', 'hi': 'hi-IN-MadhurNeural', 'zh-CN': 'zh-CN-YunxiNeural'
}
...
def process_voice():
    try:
        ...
        # FFmpeg filterləri ilə səsi studiya səviyyəsinə gətiririk
        os.system(f"ffmpeg -i {raw_p} -af 'highpass=f=80, lowpass=f=8000, afftdn, volume=1.8' -ar 16000 -ac 1 -y {clean_p}")
        ...
        with sr.AudioFile(clean_p) as source:
            ...
            # Azərbaycan dilini ana dili kimi tanıyır
            ...
            out_mp3 = f"static/neural_{uid}.mp3"
            ...
            if os.path.exists(clean_p): os.remove(clean_p)
